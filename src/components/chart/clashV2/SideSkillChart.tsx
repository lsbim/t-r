...
const ClashV2SkillChart = ({ data }: { data: ClashV2SeasonData }) => {
    ...
    return (
        <div className={`lg:w-[992px] dark:brightness-90 w-full mx-auto flex flex-col gap-y-3 h-[290px] ${containerDarkBG} dark:border-zinc-700 p-4 rounded-xl border border-zinc-300 overflow-x-auto overflow-y-hidden`}>
