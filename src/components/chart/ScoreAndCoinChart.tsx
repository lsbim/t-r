...
const ScoreAndCoinChart: React.FC<ScoreAndCoinChartProps> = ({
    ...
    return (
        <div className={`w-full mx-auto flex flex-col h-[516px] ${containerDarkBG} dark:text-zinc-200 p-4 rounded-xl border border-zinc-300 dark:border-zinc-700 overflow-x-auto overflow-y-hidden`}>
