            ...
            {raidValues.map((raid, index) => {
                ...
                return (
                    <Link
                        ...
                        className={`absolute ${raidPosition} ${raidBGColor} ${raidTextColor} w-1/4 sm:w-[200px] flex flex-col justify-center items-center hover:animate-pulse transition cursor-pointer z-20`}
