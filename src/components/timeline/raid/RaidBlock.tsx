            ...
            {raidValues.map((raid, index) => {
                ...
                return (
                    <Link
                        ...
                        className={`absolute dark:brightness-90 ${raidPosition} ${raidBGColor} ${raidTextColor} w-1/4 sm:w-[200px] flex flex-col justify-center items-center cursor-pointer z-20 hover:brightness-90 hover:shadow-xl dark:shadow-zinc-900 transition-all duration-300`}
