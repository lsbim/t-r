        ...
        <div
            ...
            <div className="flex mt-2 h-6 w-full font-bold">
                <button
                    ...
                    className="bg-gray-200 dark:bg-zinc-600 flex items-center justify-center cursor-pointer w-[50%] hover:bg-gray-300 dark:hover:bg-zinc-500 transition-colors duration-100">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
