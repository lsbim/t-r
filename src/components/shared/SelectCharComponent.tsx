                        ...
                        <div className="w-[20%] flex flex-col justify-center ">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="flex-col gap-2 flex">
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[6] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[6] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[7] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[7] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[8] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                ...
                                <div className="flex-col gap-2 flex">
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[3] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[3] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[4] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[4] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[5] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                ...
                                <div className="flex-col gap-2 flex">
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[0] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[0] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[1] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
                                            backgroundColor: `rgba(200, 0, 0, ${statsForSelect.positionCounts[1] / statsForSelect.totalUses})`
                                        }} />
                                    <div className="relative w-6 h-6 border-[1px] border-gray-800"
                                        data-tooltip={`${(statsForSelect.positionCounts[2] / statsForSelect.totalUses * 100).toFixed(1)}%`}
                                        style={{
