...
const BestComp = ({ data }: { data: CompStat[] }) => {
    ...
    return (
        <div className={`lg:w-[992px] w-full mx-auto flex flex-col ${containerDarkBG} py-4 rounded-xl border border-zinc-300 dark:border-zinc-700 overflow-x-auto gap-y-3`}>
