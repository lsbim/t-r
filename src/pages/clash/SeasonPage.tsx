            ...
            {seasonSlice.type === 'external' && (
                <>
                    ...
                    <ExternalPickRateChart
                        ...
                        data={seasonSlice}
                    />
                    <div className="lg:w-[992px] w-full mx-auto flex h-4 dark:bg-zinc-900 dark:text-zinc-200 bg-white p-4 shadow-md mt-1 text-[12px] lg:text-[13px] items-center justify-center">
