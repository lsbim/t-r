...
const ItemIcon = ({
    ...
    return (
        <div
            className={`dark:brightness-90 relative rounded-lg overflow-hidden bg-center bg-no-repeat bg-contain flex items-center justify-center ${grayscale ? 'grayscale' : ''}`}
            style={{
                width: size || 60,
                height: size || 60,
