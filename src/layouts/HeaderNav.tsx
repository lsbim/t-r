...
const HeaderNav = () => {
    ...
    return (
        <div className={`bg-white py-4 flex items-center justify-center gap-8 font-bold border-b-4 w-full 
        ${pathname.startsWith("/clash") || pathname === "/" ? "border-yellow-300" :
                pathname.startsWith("/stat") ? "border-y-rose-300" : "border-emerald-300"}`}>
